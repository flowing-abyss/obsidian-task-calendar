...
describe('parseTask', () => {
  ...
  it('parses start date', () => {
    const t = parseTask('- [ ] Long task 🛫 2026-06-20 📅 2026-06-30', { filePath: 'f.md', line: 0 })
  ...
  it('strips globalTaskFilter tag', () => {
    const t = parseTask('- [ ] #task/one-off Buy milk', { filePath: 'f.md', line: 0, globalTaskFilter: '#task/one-off' })
